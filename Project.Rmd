...
country_data$ISO_Code <- countrycode(
  sourcevar = country_data$region,
  origin = "country.name",
  destination = "iso3c"
)
...
ggplot(merged_data, aes(fill = Mortality, map_id = region)) +
  ...
  labs(
    title = "Distribution of Mortality Among Regions and Countries",
